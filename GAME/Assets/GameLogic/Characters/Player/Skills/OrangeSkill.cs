...
public class OrangeSkill : AbstractAbility
{
    SkillManager manager;
    KeyCode key;
    Color col = new Color(233, 135, 0, 255);
    public float CD = 3f;
    public float cast = 0f;
    public float time = 1f;
    public float timenow;
    public string SkillName = "OrangeSKill";
    public Sprite SkillIMG;
    public string Desc = "Orange";
    public float Delay;
    Color origin;
    Renderer rend;
    bool isactive = false;
    ...
    void Start()
    {
        SkillIMG = Resources.Load<Sprite>("Textures/Orange");
